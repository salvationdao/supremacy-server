...
var streams = []*server.Stream{
	{
		...
		URL:           "wss://watch-us-west-1.supremacy.game/WebRTCAppEE/play.html?name=886200805704583109786601",
		StreamID:      "thisisID",
		Region:        "us-west",
	...
	},
	{
		...
		Name:          "USA Phoenix",
		URL:           "wss://watch-us-mid-west-1.supremacy.game/WebRTCAppEE/play.html?name=886200805704583109786601",
		StreamID:      "thisisID",
		Region:        "us-mid-west",
		Resolution:    "1920x1080",
		BitRatesKBits: 1500,
	...
	},
	{
		...
		Name:          "AU Sydney",
		URL:           "wss://watch-au-east-1.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "au-east",
		Resolution:    "1920x1080",
		BitRatesKBits: 5000,
	...
	},
	{
		...
		Name:          "AU Melbourne",
		URL:           "wss://watch-au-south-1.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "au-south",
		Resolution:    "1920x1080",
		BitRatesKBits: 5000,
	...
	},
	{
		...
		Name:          "USA New York",
		URL:           "wss://watch-us-east-1.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "us-east",
		Resolution:    "1920x1080",
		BitRatesKBits: 5000,
	...
	},
	{
		...
		Name:          "USA Washington",
		URL:           "wss://watch-us-nw-1.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "us-northwest",
		Resolution:    "1920x1080",
		BitRatesKBits: 5000,
	...
	},
	{
		...
		Name:          "AU Perth",
		URL:           "wss://watch-au-west-1.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "au-west",
		Resolution:    "1920x1080",
		BitRatesKBits: 5000,
	...
	},
	{
		...
		Name:          "AU Sydney",
		URL:           "wss://watch-au-east-2.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "au-east",
		Resolution:    "1920x1080",
		BitRatesKBits: 5000,
	...
	},
	{
		...
		Name:          "Spain Madrid",
		URL:           "wss://watch-eu-1.supremacy.game/WebRTCAppEE/play.html?name=079583650308221367643",
		StreamID:      "thisisID",
		Region:        "eu-spain",
		Resolution:    "1920x1080",
		BitRatesKBits: 900,
