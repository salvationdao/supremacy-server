...
const HubKeyNewRepairOfferSubscribe = "NEW:MECH:REPAIR:OFFER"
const HubKeyRepairOfferList = "MECH:REPAIR:OFFER:LIST"
...
const HubKeyAssetRepairCase = "ASSET:REPAIR:CASE"
