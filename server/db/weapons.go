...
func WeaponListDetailed(opts *WeaponListOpts) (int64, []*server.Weapon, error) {
	...
	queryMods = append(queryMods,
		qm.Select(
			...
			boiler.BlueprintWeaponTableColumns.PowerInstantDrain,
			boiler.BlueprintWeaponTableColumns.IsMelee,
			boiler.BlueprintWeaponTableColumns.MaxAmmo,
			boiler.BlueprintWeaponTableColumns.ProjectileAmount,
			boiler.BlueprintWeaponTableColumns.DotTickDamage,
			boiler.BlueprintWeaponTableColumns.DotMaxTicks,
			boiler.BlueprintWeaponTableColumns.IsArced,
			boiler.BlueprintWeaponTableColumns.ChargeTimeSeconds,
			boiler.BlueprintWeaponTableColumns.BurstRateOfFire,
			boiler.BlueprintWeaponTableColumns.DotTickDuration,
			boiler.BlueprintWeaponTableColumns.ProjectileLifeSpan,
			boiler.BlueprintWeaponTableColumns.RecoilForce,
			boiler.BlueprintWeaponTableColumns.IdlePowerCost,
