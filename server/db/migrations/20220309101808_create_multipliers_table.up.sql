...
INSERT INTO multipliers (key, value, description, for_games, multiplier_type, test_number, test_string) VALUES
    ('citizen', 10, 'When a player is within the top 80% of voting average.', 1, 'spend_average', 80, ''),
    ('supporter', 25, 'When a player is within the top 50% of voting average.', 1, 'spend_average', 50, ''),
    ('contributor', 50, 'When a player is within the top 25% of voting average.', 1, 'spend_average', 25, ''),
    ('super contributor', 50, 'When a player is within the top 10% of voting average.', 1, 'spend_average', 10, ''),
