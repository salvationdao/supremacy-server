                ...
                CASE
                    WHEN weapon_model.faction_id = (SELECT id FROM factions WHERE label = 'Zaibatsu Heavy Industries')
                        THEN UPDATE weapon_models
                             SET default_skin_id = (SELECT id
                                                    ...
                                                    WHERE weapon_model_id = weapon_model.id AND label = 'ZHI Default')
                             WHERE id = weapon_model.id;
                    WHEN weapon_model.faction_id = (SELECT id FROM factions WHERE label = 'Boston Cybernetics')
                        THEN UPDATE weapon_models
                             SET default_skin_id = (SELECT id
                                                    FROM blueprint_weapon_skin
                                                    WHERE weapon_model_id = weapon_model.id AND label = 'BC Default')
                             WHERE id = weapon_model.id;
                    WHEN weapon_model.faction_id =
                        ...
                        THEN UPDATE weapon_models
                             SET default_skin_id = (SELECT id
                                                    FROM blueprint_weapon_skin
                                                    WHERE weapon_model_id = weapon_model.id AND label = 'RMOMC Default')
                             WHERE id = weapon_model.id;
        ...
        FOR blueprint_weapon IN SELECT * FROM blueprint_weapons
            LOOP
                ...
                SET weapon_model_id = (SELECT id
                                       FROM weapon_models
                                       WHERE label = blueprint_weapon.label AND faction_id IS NULL)
...
$$
    ...
    BEGIN
        FOR mech_model IN SELECT id, mech_type FROM mech_models WHERE brand_id IS NOT NULL
            LOOP
                CASE
                ...
                CASE
                    WHEN model.faction_id = (SELECT id FROM factions WHERE label = 'Zaibatsu Heavy Industries')
                        THEN UPDATE mech_models
                             SET default_chassis_skin_id = (SELECT id
                                                            ...
                                                            WHERE mech_model = model.id AND label = 'ZHI Default')
                             WHERE id = model.id;
                    WHEN model.faction_id = (SELECT id FROM factions WHERE label = 'Boston Cybernetics')
                        THEN UPDATE mech_models
                             SET default_chassis_skin_id = (SELECT id
                                                            FROM blueprint_mech_skin
                                                            WHERE mech_model = model.id AND label = 'BC Default')
                             WHERE id = model.id;
                    WHEN model.faction_id =
                        ...
                        THEN UPDATE mech_models
                             SET default_chassis_skin_id = (SELECT id
                                                            FROM blueprint_mech_skin
                                                            WHERE mech_model = model.id AND label = 'RMOMC Default')
                             WHERE id = model.id;
            ...
            LOOP
                                                                         ...
                                                                         WHERE mech_type = 'HUMANOID'
                                                                           ...
                                                                           AND label =
                                                                               CASE
                                                                                   ...
                                                                                   WHEN i > (.30 * (mechCrateLen * .80)) AND i <= (.55 * (mechCrateLen * .80))
                                                                                       THEN
                                                                                       CASE
                                                                                           WHEN faction.label = 'Boston Cybernetics'
                                                                                           ...
                                                                                           END
                                                                                   --17% for camo
                                                                                   WHEN i > (.55 * (mechCrateLen * .80)) AND i <= (.72 * (mechCrateLen * .80))
                                                                                       THEN
                                                                                       CASE
                                                                                           WHEN faction.label = 'Boston Cybernetics'
                                                                                               THEN 'Blue Camo'
                                                                                           ...
                                                                                           END
                                                                                   --17% for theme
                                                                                   WHEN i > (.72 * (mechCrateLen * .80)) AND i <= (.89 * (mechCrateLen * .80))
                                                                                       THEN
                                                                                       CASE
                                                                                           WHEN faction.label = 'Boston Cybernetics'
                                                                                               THEN 'Police'
                                                                                           ...
                                                                                           END
                                                                                   --10% for Gold
                                                                                   WHEN i > (.89 * (mechCrateLen * .80)) AND i <= (.99 * (mechCrateLen * .80))
                                                                                       THEN 'Gold'
                                                                                   --1% for rare color
                                                                                   WHEN i > (.99 * (mechCrateLen * .80)) AND i <= (1 * (mechCrateLen * .80))
                                                                                       THEN
                                                                                       CASE
                                                                                           WHEN faction.label = 'Boston Cybernetics'
                                                                                               THEN 'Crystal'
                                                                                   ...
                                                                                   END));
                                     i := i + 1;
                            -- for other 20% of the Mechs, insert a mech object from the appropriate brand's platform mechs and a fitted power core
                                 ...
                                 VALUES (mechCrate.id, 'MECH_SKIN', (SELECT id
                                                                     ...
                                                                     WHERE mech_type = 'PLATFORM'
                                                                       ...
                                                                       AND label =
                                                                           CASE
                                                                               --30% default skin
                                                                               WHEN i <= ((.30 * (mechCrateLen * .20)) + (mechCrateLen * .80))
                                                                                   THEN
                                                                                   CASE
                                                                                       WHEN faction.label = 'Boston Cybernetics'
                                                                                           THEN 'BC Default'
                                                                               ...
                                                                               --25% for manufacturer's skin
                                                                               WHEN i >
                                                                                    ((.30 * (mechCrateLen * .20)) + (mechCrateLen * .80)) AND
                                                                                    i <=
                                                                                    ((.55 * (mechCrateLen * .20)) + (mechCrateLen * .80))
                                                                                   THEN
                                                                                   CASE
                                                                                       WHEN faction.label = 'Boston Cybernetics'
                                                                                           THEN 'Daison Avionics'
                                                                               ...
                                                                               --17% for camo
                                                                               WHEN i >
                                                                                    ((.55 * (mechCrateLen * .20)) + (mechCrateLen * .80)) AND
                                                                                    i <=
                                                                                    ((.72 * (mechCrateLen * .20)) + (mechCrateLen * .80))
                                                                                   THEN
                                                                                   CASE
                                                                                       WHEN faction.label = 'Boston Cybernetics'
                                                                                           THEN 'Blue Camo'
                                                                               ...
                                                                               --17% for theme
                                                                               WHEN i >
                                                                                    ((.72 * (mechCrateLen * .20)) + (mechCrateLen * .80)) AND
                                                                                    i <=
                                                                                    ((.89 * (mechCrateLen * .20)) + (mechCrateLen * .80))
                                                                                   THEN
                                                                                   CASE
                                                                                       WHEN faction.label = 'Boston Cybernetics'
                                                                                           THEN 'Police'
                                                                               ...
                                                                               --10% for Gold
                                                                               WHEN i >
                                                                                    ((.89 * (mechCrateLen * .20)) + (mechCrateLen * .80)) AND
                                                                                    i <=
                                                                                    ((.99 * (mechCrateLen * .20)) + (mechCrateLen * .80))
                                                                                   THEN 'Gold'
                                                                               --1% for rare color
                                                                               WHEN i >
                                                                                    ((.99 * (mechCrateLen * .20)) + (mechCrateLen * .80)) AND
                                                                                    i <=
                                                                                    ((1 * (mechCrateLen * .20)) + (mechCrateLen * .80))
                                                                                   THEN
                                                                                   CASE
                                                                                       WHEN faction.label = 'Boston Cybernetics'
                                                                                           THEN 'Crystal'
                ...
                FOR weaponCrate IN SELECT * FROM mystery_crate WHERE faction_id = faction.id AND type = 'WEAPON'
                    LOOP
                        --flak: all factions
                        CASE
                            --random rarities, will adjust later

                            WHEN i <= (mechCrateLen * .20)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                                                        ...
                                                                        WHERE weapon_type = 'Flak'
                                                                          AND brand_id =
                                                                              CASE
                                                                                  ...
                                                                                  END));
--                                      INSERT INTO mystery_crate_blueprints (id, mystery_crate_id, blueprint_type, blueprint_id)
...
--                                                                                    CASE
--                                                                                        WHEN faction.label = 'Boston Cybernetics'
--                                                                                            THEN (SELECT id FROM weapon_models WHERE label = 'Archon Miltech Flak')
--                                                                                        WHEN faction.label = 'Zaibatsu Heavy Industries'
--                                                                                            THEN (SELECT id FROM weapon_models WHERE label = 'ZHI Humanoid')
--                                                                                        WHEN faction.label = 'Red Mountain Offworld Mining Corporation'
--                                                                                            THEN (SELECT id FROM weapon_models WHERE label = 'RMOMC Humanoid')
--                                                                                        END
--                                                                                AND label =
--                                                                                    CASE
--                                                                                        --30% default skin
...
--                                                                                        END))
                            ...
                            WHEN i > (mechCrateLen * .20) AND i <= ((mechCrateLen * .30)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                     VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                                        FROM blueprint_weapons
                            ...
                            WHEN i > (mechCrateLen * .30) AND i <= (mechCrateLen * .40)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                     VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                                        FROM blueprint_weapons
                            ...
                            WHEN i > (mechCrateLen * .40) AND i <= (mechCrateLen * .50)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                     VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                                        FROM blueprint_weapons
                            ...
                            WHEN i > (mechCrateLen * .50) AND i <= (mechCrateLen * .60)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                     VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                                        FROM blueprint_weapons
                            ...
                            WHEN i > (mechCrateLen * .60) AND i <= (mechCrateLen * .70)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                     VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                                        FROM blueprint_weapons
                                                                        WHERE weapon_type =
                            ...
                            WHEN i > (mechCrateLen * .80) AND i <= (mechCrateLen * .90)
                                THEN INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                                     VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                                        FROM blueprint_weapons
                                                                        WHERE weapon_type =
                            ...
                            ELSE -- this will be the most common item, the rest will be designated as this
                            INSERT INTO mystery_crate_blueprints (mystery_crate_id, blueprint_type, blueprint_id)
                            VALUES (weaponCrate.id, 'WEAPON', (SELECT id
                                                               FROM blueprint_weapons
                                                               WHERE weapon_type =
