...
CREATE TABLE weapon_model_skin_compatibilities
(
    blueprint_weapon_skin_id UUID        NOT NULL REFERENCES blueprint_weapon_skin,
    weapon_model_id          UUID        NOT NULL REFERENCES weapon_models,
    image_url                TEXT,
    card_animation_url       TEXT,
    avatar_url               TEXT,
    large_image_url          TEXT,
