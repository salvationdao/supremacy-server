...
ALTER TABLE blueprint_weapons
    ADD COLUMN dot_tick_duration numeric NOT NULL DEFAULT 0,
    ADD COLUMN projectile_life_span numeric NOT NULL DEFAULT 50,
    ADD COLUMN recoil_force decimal NOT NULL DEFAULT 1,
    ADD COLUMN idle_power_cost numeric NOT NULL DEFAULT 0;

ALTER TABLE blueprint_power_cores
    ADD COLUMN weapon_share int4 NOT NULL DEFAULT 40,
    ADD COLUMN movement_share int4 NOT NULL DEFAULT 20,
    ADD COLUMN utility_share int4 NOT NULL DEFAULT 20,
