...
var (
	...
	issuedContractRewardColumnsWithoutDefault = []string{"battle_id", "reward", "war_machine_hash"}
	issuedContractRewardColumnsWithDefault    = []string{"id", "deleted_at", "updated_at", "created_at", "is_paid"}
	issuedContractRewardPrimaryKeyColumns     = []string{"id"}
	issuedContractRewardGeneratedColumns      = []string{}
)
