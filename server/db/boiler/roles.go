...
type Role struct {
	...
	RoleType string `boiler:"role_type" boil:"role_type" json:"role_type" toml:"role_type" yaml:"role_type"`
...
var RoleWhere = struct {
	...
	RoleType whereHelperstring
}{
	ID:       whereHelperstring{field: "\"roles\".\"id\""},
	RoleType: whereHelperstring{field: "\"roles\".\"role_type\""},
}
...
var (
	roleAllColumns            = []string{"id", "role_type"}
	roleColumnsWithoutDefault = []string{}
	roleColumnsWithDefault    = []string{"id", "role_type"}
...
func (o *Role) Players(mods ...qm.QueryMod) playerQuery {
...
func (roleL) LoadPlayers(e boil.Executor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		qm.From(`players`),
		qm.WhereIn(`players.role_id in ?`, args...),
		qmhelper.WhereIsNull(`players.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
...
func (o *Role) AddPlayers(exec boil.Executor, insert bool, related ...*Player) error {
	var err error
