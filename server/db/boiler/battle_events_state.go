...
var (
	...
	battleEventsStateColumnsWithoutDefault = []string{"event_id", "detail"}
	battleEventsStateColumnsWithDefault    = []string{"id", "state"}
	battleEventsStatePrimaryKeyColumns     = []string{"id"}
	battleEventsStateGeneratedColumns      = []string{}
)
