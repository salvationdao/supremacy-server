...
var (
	mechAllColumns            = []string{"id", "owner_id", "template_id", "chassis_id", "tier", "is_default", "image_url", "animation_url", "hash", "name", "label", "slug", "deleted_at", "updated_at", "created_at"}
	mechColumnsWithoutDefault = []string{"owner_id", "template_id", "chassis_id", "tier", "image_url", "animation_url", "hash", "name", "label", "slug"}
