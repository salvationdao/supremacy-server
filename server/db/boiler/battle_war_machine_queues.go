...
var (
	...
	battleWarMachineQueueColumnsWithoutDefault = []string{"war_machine_metadata"}
	battleWarMachineQueueColumnsWithDefault    = []string{"queued_at", "deleted_at", "is_insured", "contract_reward", "fee", "war_machine_hash", "faction_id", "created_at", "id"}
	battleWarMachineQueuePrimaryKeyColumns     = []string{"id"}
	battleWarMachineQueueGeneratedColumns      = []string{}
)
