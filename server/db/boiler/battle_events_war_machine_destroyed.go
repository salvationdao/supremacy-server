...
var (
	...
	battleEventsWarMachineDestroyedColumnsWithoutDefault = []string{"event_id"}
	battleEventsWarMachineDestroyedColumnsWithDefault    = []string{"id", "related_event_id", "destroyed_war_machine_hash", "kill_by_war_machine_hash"}
	battleEventsWarMachineDestroyedPrimaryKeyColumns     = []string{"id"}
	battleEventsWarMachineDestroyedGeneratedColumns      = []string{}
)
