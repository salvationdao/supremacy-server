...
type GameAbility struct {
	...
	TriggerCountdownSeconds int         `boiler:"trigger_countdown_seconds" boil:"trigger_countdown_seconds" json:"trigger_countdown_seconds" toml:"trigger_countdown_seconds" yaml:"trigger_countdown_seconds"`
...
var GameAbilityColumns = struct {
	...
	DeletedAt               string
	TriggerCountdownSeconds string
}{
	ID:                      "id",
	...
	TriggerCountdownSeconds: "trigger_countdown_seconds",
}
...
var GameAbilityTableColumns = struct {
	...
	TriggerCountdownSeconds: "game_abilities.trigger_countdown_seconds",
}
...
var GameAbilityWhere = struct {
	...
	TriggerCountdownSeconds whereHelperint
}{
	...
	TriggerCountdownSeconds: whereHelperint{field: "\"game_abilities\".\"trigger_countdown_seconds\""},
}
...
var (
	gameAbilityAllColumns            = []string{"id", "game_client_ability_id", "faction_id", "battle_ability_id", "label", "colour", "image_url", "sups_cost", "description", "text_colour", "current_sups", "level", "location_select_type", "deleted_at", "trigger_countdown_seconds"}
	gameAbilityColumnsWithoutDefault = []string{"game_client_ability_id", "faction_id", "label", "colour", "image_url", "description", "text_colour"}
	gameAbilityColumnsWithDefault    = []string{"id", "battle_ability_id", "sups_cost", "current_sups", "level", "location_select_type", "deleted_at", "trigger_countdown_seconds"}
