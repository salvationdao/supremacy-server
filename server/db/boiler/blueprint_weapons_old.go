...
func (o *BlueprintWeaponsOld) WeaponModel(mods ...qm.QueryMod) blueprintWeaponQuery {
...
func (blueprintWeaponsOldL) LoadWeaponModel(e boil.Executor, singular bool, maybeBlueprintWeaponsOld interface{}, mods queries.Applicator) error {
	var slice []*BlueprintWeaponsOld
	var object *BlueprintWeaponsOld

	if singular {
		object = maybeBlueprintWeaponsOld.(*BlueprintWeaponsOld)
	} else {
		slice = *maybeBlueprintWeaponsOld.(*[]*BlueprintWeaponsOld)
	}

	args := make([]interface{}, 0, 1)
	if singular {
		if object.R == nil {
			object.R = &blueprintWeaponsOldR{}
		}
	...
	if singular {
		...
		foreign.R.WeaponModelBlueprintWeaponsOlds = append(foreign.R.WeaponModelBlueprintWeaponsOlds, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.WeaponModelID == foreign.ID {
				...
				foreign.R.WeaponModelBlueprintWeaponsOlds = append(foreign.R.WeaponModelBlueprintWeaponsOlds, local)
				break
			}
		}
	}
...
// SetWeaponModel of the blueprintWeaponsOld to the related item.
// Sets o.R.WeaponModel to related.
// Adds o to related.R.WeaponModelBlueprintWeaponsOlds.
func (o *BlueprintWeaponsOld) SetWeaponModel(exec boil.Executor, insert bool, related *BlueprintWeapon) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &blueprintWeaponR{
			WeaponModelBlueprintWeaponsOlds: BlueprintWeaponsOldSlice{o},
		}
	} else {
		related.R.WeaponModelBlueprintWeaponsOlds = append(related.R.WeaponModelBlueprintWeaponsOlds, o)
	}
