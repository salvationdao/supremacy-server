...
var (
	...
	battleEventsGameAbilityColumnsWithoutDefault = []string{"event_id"}
	battleEventsGameAbilityColumnsWithDefault    = []string{"id", "game_ability_id", "is_triggered", "triggered_by_user_id", "triggered_on_cell_x", "triggered_on_cell_y", "ability_hash"}
	battleEventsGameAbilityPrimaryKeyColumns     = []string{"id"}
	battleEventsGameAbilityGeneratedColumns      = []string{}
)
