...
type Language struct {
	...
	R *languageR `boiler:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L languageL  `boiler:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var (
	languageAllColumns            = []string{"id", "name", "created_at"}
...
func (q languageQuery) One(exec boil.Executor) (*Language, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for languages")
	}
...
func (q languageQuery) All(exec boil.Executor) (LanguageSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Language slice")
	}
...
func (q languageQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count languages rows")
	}
...
func (q languageQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if languages exists")
	}
...
func (o *Language) PlayerLanguages(mods ...qm.QueryMod) playerLanguageQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"player_languages\".\"language_id\"=?", o.ID),
	)
...
func (languageL) LoadPlayerLanguages(e boil.Executor, singular bool, maybeLanguage interface{}, mods queries.Applicator) error {
	var slice []*Language
	var object *Language
	...
	query := NewQuery(
		...
		qm.WhereIn(`player_languages.language_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Language) AddPlayerLanguages(exec boil.Executor, insert bool, related ...*PlayerLanguage) error {
	var err error
...
func FindLanguage(exec boil.Executor, iD string, selectCols ...string) (*Language, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from languages")
	}

	if err = languageObj.doAfterSelectHooks(exec); err != nil {
...
func (o *Language) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no languages provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into languages")
	}
...
func (o *Language) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update languages, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update languages row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for languages")
	}
...
func (q languageQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for languages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for languages")
	}
...
func (o LanguageSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in language slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all language")
	}
	return rowsAff, nil
}
...
func (o *Language) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no languages provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiler: unable to upsert languages, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert languages")
	}
...
func (o *Language) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Language provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from languages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for languages")
	}
...
func (q languageQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no languageQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from languages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for languages")
	}
...
func (o LanguageSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from language slice")
	}
...
func (o *LanguageSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in LanguageSlice")
	}
...
func LanguageExists(exec boil.Executor, iD string) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if languages exists")
	}
