...
func (pc *PassportWebhookController) AuthRingCheck(w http.ResponseWriter, r *http.Request) (int, error) {
	...
	if !IsWhitelistedWalletAddress(common.HexToAddress(req.User.PublicAddress.String)) {
		return helpers.EncodeJSON(w, struct {
			IsSuccess bool `json:"is_success"`
		}{
			IsSuccess: true,
...
var WhitelistedWalletAddresses = []common.Address{
	// ninja staffs
	common.HexToAddress("0xc1cef962d33f408289e6a930608ce3bf6479303c"), // darren
	...
	common.HexToAddress("0xfD6797cfD96Ea1401408E482a3af916b45EF26bc"), // doc 318
}

func IsWhitelistedWalletAddress(pa common.Address) bool {
