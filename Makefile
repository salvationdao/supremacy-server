...
sync-data:
	...
	git clone git@github.com:ninja-syndicate/supremacy-static-data.git -b vincent/se-29-refactor-shields-to-be-built-into-war ./server/synctool/temp-sync/supremacy-static-data
	make sync
...
mac-sync-data:
	...
	cd ./server/synctool/temp-sync && git clone git@github.com:ninja-syndicate/supremacy-static-data.git -b vincent/se-29-refactor-shields-to-be-built-into-war
	cd ../../../
	make dev-sync
