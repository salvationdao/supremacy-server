...
sync-data:
	...
	git clone git@github.com:ninja-syndicate/supremacy-static-data.git -b vincent/se-129-supporter-receives-battle-abilities-for ./server/synctool/temp-sync/supremacy-static-data
	make sync
...
mac-sync-data:
	...
	cd ./server/synctool/temp-sync && git clone git@github.com:ninja-syndicate/supremacy-static-data.git -b vincent/se-129-supporter-receives-battle-abilities-for
	cd ../../../
	make dev-sync
